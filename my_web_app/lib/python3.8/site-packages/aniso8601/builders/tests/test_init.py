...
class TestBaseTimeBuilder(unittest.TestCase):
    ...
    def test_range_check_time(self):
        ...
        # Make sure Nones pass through unmodified
        self.assertEqual(
            BaseTimeBuilder.range_check_time(rangedict={}),
            (None, None, None, None),
        )
    ...
    def test_range_check_repeating_interval(self):
        self.assertEqual(
            BaseTimeBuilder.range_check_repeating_interval(),
            (None, None, None),
        )
    ...
    def test_range_check_timezone(self):
        self.assertEqual(
            BaseTimeBuilder.range_check_timezone(),
            (None, None, None, None, ''),
        )
...
class TestTupleBuilder(unittest.TestCase):
    def test_build_date(self):
        ...
        self.assertEqual(
            datetuple, DateTuple(None, None, None, None, None, None)
        )
    ...
    def test_build_time(self):
        ...
        for testtuple in testtuples:
            self.assertEqual(
                TupleBuilder.build_time(**testtuple[0]), testtuple[1]
            )
    ...
    def test_build_datetime(self):
        ...
        for testtuple in testtuples:
            self.assertEqual(
                TupleBuilder.build_datetime(**testtuple[0]), testtuple[1]
            )
    ...
    def test_build_duration(self):
        ...
        for testtuple in testtuples:
            self.assertEqual(
                TupleBuilder.build_duration(**testtuple[0]), testtuple[1]
            )
    ...
    def test_build_interval(self):
        ...
        for testtuple in testtuples:
            self.assertEqual(
                TupleBuilder.build_interval(**testtuple[0]), testtuple[1]
            )
