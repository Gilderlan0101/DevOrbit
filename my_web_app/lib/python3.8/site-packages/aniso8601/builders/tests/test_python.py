...
class TestPythonTimeBuilder_UtiltyFunctions(unittest.TestCase):
    ...
    def test_fractional_range_check(self):
        ...
        self.assertEqual(
            fractional_range_check(10, '-0.1', limit),
            FractionalComponent(-0, 1),
        )
    ...
    def test_cast_to_fractional_component(self):
        ...
        self.assertEqual(
            _cast_to_fractional_component(10, '-1.1'),
            FractionalComponent(-1, 1),
        )

        self.assertEqual(
            _cast_to_fractional_component(100, '1.1'),
            FractionalComponent(1, 10),
        )
        self.assertEqual(
            _cast_to_fractional_component(100, '-1.1'),
            FractionalComponent(-1, 10),
...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_time(self):
        testtuples = (
            ...
            (
                {'hh': '1', 'mm': '23.4567'},
                datetime.time(
                    hour=1, minute=23, second=27, microsecond=402000
                ),
            ),
            (
                {'hh': '14', 'mm': '43.999999997'},
                datetime.time(
                    hour=14, minute=43, second=59, microsecond=999999
                ),
            ),
            (
                {'hh': '1', 'mm': '23', 'ss': '45'},
            ...
            (
                ...
                datetime.time(
                    hour=23, minute=21, second=28, microsecond=512400
                ),
            ),
            (
    ...
    def test_build_duration(self):
        testtuples = (
            ...
            (
                ...
                datetime.timedelta(
                    hours=1, minutes=3, seconds=11, microseconds=858714
                ),
            ),
            (
            ...
            (
                ...
                datetime.timedelta(
                    days=729999, seconds=86399, microseconds=999999
                ),
            ),
            (
    ...
    def test_build_repeating_interval(self):
        ...
        for dateindex in compat.range(0, 11):
            self.assertEqual(
                ...
                (
                    datetime.datetime(
                        year=1981, month=4, day=5, hour=0, minute=0
                    )
    ...
    def test_range_check_duration(self):
        ...
        with self.assertRaises(SecondsOutOfBoundsError):
            PythonTimeBuilder.build_duration(
                TnS=str(
                    (datetime.timedelta.max.days * 24 * 60 * 60) + 24 * 60 * 60
                )
            )
        ...
        with self.assertRaises(YearOutOfBoundsError):
            PythonTimeBuilder.build_interval(
                ...
                duration=DurationTuple(
                    ...
                    None,
                    None,
                    str(datetime.timedelta.max.days),
                    None,
                    None,
                    None,
                ),
    ...
    def test_distribute_microseconds(self):
        self.assertEqual(
            PythonTimeBuilder._distribute_microseconds(1, (), ()), (1,)
        )
        self.assertEqual(
