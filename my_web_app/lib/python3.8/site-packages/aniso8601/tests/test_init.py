...
class TestInitFunctions(unittest.TestCase):
    def test_import(self):
        ...
        self.assertEqual(
            aniso8601.parse_datetime, aniso8601.time.parse_datetime
        )
        ...
        self.assertEqual(
            aniso8601.parse_duration, aniso8601.duration.parse_duration
        )
        self.assertEqual(
        ...
        self.assertEqual(
            aniso8601.parse_interval, aniso8601.interval.parse_interval
        )
        self.assertEqual(
