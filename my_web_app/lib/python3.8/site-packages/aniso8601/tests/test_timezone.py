...
class TestTimezoneParserFunctions(unittest.TestCase):
    def test_parse_timezone(self):
        testtuples = (
            ...
            (
                '+0000',
                {'negative': False, 'hh': '00', 'mm': '00', 'name': '+0000'},
            ),
            (
                '+0100',
                {'negative': False, 'hh': '01', 'mm': '00', 'name': '+0100'},
            ),
            (
                '-0100',
                {'negative': True, 'hh': '01', 'mm': '00', 'name': '-0100'},
            ),
            (
                '+0012',
                {'negative': False, 'hh': '00', 'mm': '12', 'name': '+0012'},
            ),
            (
                '+0123',
                {'negative': False, 'hh': '01', 'mm': '23', 'name': '+0123'},
            ),
            (
                '-0123',
                {'negative': True, 'hh': '01', 'mm': '23', 'name': '-0123'},
            ),
            (
                '+00',
                {'negative': False, 'hh': '00', 'mm': None, 'name': '+00'},
            ),
            (
                '+01',
                {'negative': False, 'hh': '01', 'mm': None, 'name': '+01'},
            ),
            ('-01', {'negative': True, 'hh': '01', 'mm': None, 'name': '-01'}),
            (
                '+12',
                {'negative': False, 'hh': '12', 'mm': None, 'name': '+12'},
            ),
