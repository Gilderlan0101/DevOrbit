...
class TestIntervalParser_UtilityFunctions(unittest.TestCase):
    ...
    def test_get_interval_component_resolution(self):
        self.assertEqual(
            _get_interval_component_resolution(
                DateTuple(
                    YYYY='2001', MM=None, DD=None, Www=None, D=None, DDD='123'
                )
            ),
        ...
        self.assertEqual(
            _get_interval_component_resolution(
                DateTuple(
                    YYYY='2001', MM=None, DD=None, Www='12', D='3', DDD=None
                )
            ),
        ...
        self.assertEqual(
            _get_interval_component_resolution(
                DateTuple(
                    YYYY='2001', MM=None, DD=None, Www='12', D=None, DDD=None
                )
            ),
        ...
        self.assertEqual(
            _get_interval_component_resolution(
                DateTuple(
                    YYYY='2001', MM='02', DD=None, Www=None, D=None, DDD=None
                )
            ),
        ...
        self.assertEqual(
            _get_interval_component_resolution(
                DateTuple(
                    YYYY='2001', MM=None, DD=None, Www=None, D=None, DDD=None
                )
            ),
...
class TestIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        self.assertEqual(
            get_interval_resolution('P1.5Y/2018'), IntervalResolution.Year
        )
        self.assertEqual(
        ...
        self.assertEqual(
            get_interval_resolution('2018/P1.5Y'), IntervalResolution.Year
        )
        self.assertEqual(
...
class TestRepeatingIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        ...
        self.assertEqual(
            get_repeating_interval_resolution('R/2018/P1.5Y'),
            IntervalResolution.Year,
        )
        self.assertEqual(
