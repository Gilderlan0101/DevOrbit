...
class TestTimeResolutionFunctions(unittest.TestCase):
    def test_get_time_resolution(self):
        self.assertEqual(
            get_time_resolution('01:23:45'), TimeResolution.Seconds
        )
        self.assertEqual(
            get_time_resolution('24:00:00'), TimeResolution.Seconds
        )
        self.assertEqual(
            get_time_resolution('23:21:28,512400'), TimeResolution.Seconds
        )
        self.assertEqual(
            get_time_resolution('23:21:28.512400'), TimeResolution.Seconds
        )
        ...
        self.assertEqual(
            get_time_resolution('01:23,4567'), TimeResolution.Minutes
        )
        self.assertEqual(
            get_time_resolution('01:23.4567'), TimeResolution.Minutes
        )
        ...
        self.assertEqual(
            get_time_resolution('0123.4567+00:00'), TimeResolution.Minutes
        )
        self.assertEqual(
            get_time_resolution('01.4567+00:00'), TimeResolution.Hours
        )
        self.assertEqual(
            get_time_resolution('01:23:45+00:00'), TimeResolution.Seconds
        )
        self.assertEqual(
            get_time_resolution('24:00:00+00:00'), TimeResolution.Seconds
        )
        self.assertEqual(
        ...
        self.assertEqual(
            get_time_resolution('01:23+00:00'), TimeResolution.Minutes
        )
        self.assertEqual(
            get_time_resolution('24:00+00:00'), TimeResolution.Minutes
        )
        self.assertEqual(
    ...
    def test_get_datetime_resolution(self):
        ...
        self.assertEqual(
            get_datetime_resolution('2019-06-05T01'), TimeResolution.Hours
        )
    ...
    def test_get_time_resolution_internal(self):
        self.assertEqual(
            _get_time_resolution(
                TimeTuple(hh='01', mm='02', ss='03', tz=None)
            ),
            TimeResolution.Seconds,
        )
        self.assertEqual(
            _get_time_resolution(
                TimeTuple(hh='01', mm='02', ss=None, tz=None)
            ),
            TimeResolution.Minutes,
        )
        self.assertEqual(
            _get_time_resolution(
                TimeTuple(hh='01', mm=None, ss=None, tz=None)
            ),
...
class TestTimeParserFunctions(unittest.TestCase):
    def test_parse_time(self):
        testtuples = (
            ...
            (
                '01:23,4567',
                {'hh': '01', 'mm': '23.4567', 'ss': None, 'tz': None},
            ),
            (
                '01:23.4567',
                {'hh': '01', 'mm': '23.4567', 'ss': None, 'tz': None},
    ...
    def test_parse_datetime_mockbuilder(self):
        ...
        result = parse_datetime(
            '1981095T23:21:28.512400-12:34', builder=mockBuilder
        )
