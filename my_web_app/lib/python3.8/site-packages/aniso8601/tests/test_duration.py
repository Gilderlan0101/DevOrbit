...
class TestDurationParserFunctions(unittest.TestCase):
    def test_get_duration_resolution_years(self):
        self.assertEqual(
            get_duration_resolution('P1Y'), DurationResolution.Years
        )
        self.assertEqual(
            get_duration_resolution('P1,5Y'), DurationResolution.Years
        )
        self.assertEqual(
            get_duration_resolution('P1.5Y'), DurationResolution.Years
        )
    ...
    def test_get_duration_resolution_months(self):
        self.assertEqual(
            get_duration_resolution('P1Y2M'), DurationResolution.Months
        )
        self.assertEqual(
            get_duration_resolution('P1M'), DurationResolution.Months
        )
        self.assertEqual(
    ...
    def test_get_duration_resolution_weeks(self):
        self.assertEqual(
            get_duration_resolution('P1W'), DurationResolution.Weeks
        )
        self.assertEqual(
            get_duration_resolution('P1,5W'), DurationResolution.Weeks
        )
        self.assertEqual(
            get_duration_resolution('P1.5W'), DurationResolution.Weeks
        )
    ...
    def test_get_duration_resolution_days(self):
        self.assertEqual(
            get_duration_resolution('P1Y2M3D'), DurationResolution.Days
        )
        self.assertEqual(
            get_duration_resolution('P1Y2M3,5D'), DurationResolution.Days
        )
        self.assertEqual(
            get_duration_resolution('P1Y2M3.5D'), DurationResolution.Days
        )
        self.assertEqual(
            get_duration_resolution('P1D'), DurationResolution.Days
        )
        self.assertEqual(
    ...
    def test_get_duration_resolution_hours(self):
        ...
        self.assertEqual(
            get_duration_resolution('PT4H'), DurationResolution.Hours
        )
    ...
    def test_get_duration_resolution_minutes(self):
        ...
        self.assertEqual(
            get_duration_resolution('PT4H5M'), DurationResolution.Minutes
        )
