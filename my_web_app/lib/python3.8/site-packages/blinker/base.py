...
class Signal:
    ...
    def __init__(self, doc: str | None = None) -> None:
        ...
        self._by_receiver: dict[t.Any, set[t.Any]] = defaultdict(
            self.set_class
        )
    ...
    def connect(
        self, receiver: F, sender: t.Any = ANY, weak: bool = True
    ) -> F:
        ...
        if (
            'receiver_connected' in self.__dict__
            and self.receiver_connected.receivers
        ):
            try:
